...
namespace CinemaApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public IActionResult Register([FromBody] User user)
        {
            ...
            if (userWithSameEmail != null) return BadRequest("User with same email already exists");
        ...
        public IActionResult Login([FromBody] User user)
        {
            ...
            if (!SecurePasswordHasherHelper.Verify(user.Password, userEmail.Password)) return Unauthorized();
